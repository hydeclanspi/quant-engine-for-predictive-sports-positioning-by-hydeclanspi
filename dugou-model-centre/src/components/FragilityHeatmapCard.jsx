                  ...
                  {matches.map((_, colIdx) => {
                    ...
                    if (colIdx < rowIdx) {
                      ...
                      const getPremiumCell = (v) => {
                        ...
                        if (p <= -5)  return { bg: 'bg-gradient-to-br from-cyan-50/70 to-sky-50/50', border: 'border-cyan-200/45', text: 'text-emerald-500' }
                        if (p <= -2)  return { bg: 'bg-gradient-to-br from-sky-50/65 to-blue-50/45', border: 'border-sky-200/40', text: 'text-emerald-500' }
                        if (p < 0)    return { bg: 'bg-gradient-to-br from-sky-50/55 to-slate-50/40', border: 'border-sky-100/40', text: 'text-emerald-500' }
                        // 近零 — 极淡中性
