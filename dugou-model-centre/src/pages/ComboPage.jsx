        ...
        <div className="relative">
          <div className="flex items-start justify-between gap-4 mb-3.5">
            <div className="flex min-w-0 items-center gap-2.5">
              ...
              <span className="ml-1 inline-flex items-center rounded-[7px] border border-sky-200/90 bg-gradient-to-r from-white/92 via-sky-50/82 to-white/88 px-1.5 py-[1px] text-[9px] tracking-[0.03em] text-sky-700 font-semibold shadow-[inset_0_1px_0_rgba(255,255,255,0.95)] whitespace-nowrap">
                v4.9
              </span>
            </div>
            <button
